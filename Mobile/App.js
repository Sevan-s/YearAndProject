...
export default function App() {
  return (
    <NavigationContainer>
      ...
      <Stack.Screen name="Connection" component={Connection} initialParams={{'conn': servCom.getConnectVal(), 'isdeco': false}}/>
      <Stack.Screen name="Register" component={Register} initialParams={{'conn': servCom.getConnectVal(), 'isdeco': false}}/>
